  ...
  _createClass(PlacesAutocomplete, [{
    ...
    value: function autocompleteCallback(predictions, status) {
      ...
      var _props = this.props,
          ...
          autoCompletes = _props.autoCompletes;
    ...
    value: function render() {
      ...
      var disableSuggest = this.props.disableSuggest;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { className: 'btn btn-clear', type: 'button' },
            _react2.default.createElement('i', { className: 'icon ion-android-close' })
          )
        ),
        autocompleteItems.length > 0 && disableSuggest && _react2.default.createElement(
          'div',
          {
...
PlacesAutocomplete.propTypes = {
  ...
  autoCompletes: _propTypes2.default.func,
  ...
  disableSuggest: _propTypes2.default.bool,
...
PlacesAutocomplete.defaultProps = {
  ...
  disableSuggest: true,
  autoCompletes: function autoCompletes(_autoCompletes) {
